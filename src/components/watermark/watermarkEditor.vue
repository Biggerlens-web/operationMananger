<template>
    <el-dialog :model-value="dialogVisible" title="编辑水印" width="500" :before-close="handleClose">
        ...
        <el-form ref="ruleFormRef" style="max-width: 600px" :model="formData" :rules="rules" label-width="auto"
            ...
            <el-form-item label="地区" prop="signName">
                <el-input v-model="formData.signName" />
            </el-form-item>

            <el-form-item label="版本" prop="packName">
                <el-input v-model="formData.signName" />
            </el-form-item>
            <el-form-item label="水印Alpha" prop="packName">
                <el-input v-model="formData.signName" />
            </el-form-item>
            <el-form-item label="水印gap" prop="packName">
                <el-input v-model="formData.signName" />
            </el-form-item>
            <el-form-item label="水印miscut" prop="packName">
                <el-input v-model="formData.signName" />
            </el-form-item>
            <el-form-item label="水印rotate" prop="packName">
                <el-input v-model="formData.signName" />
            </el-form-item>
            <el-form-item label="水印文字rotate" prop="packName">
                <el-input v-model="formData.signName" />
            </el-form-item>
