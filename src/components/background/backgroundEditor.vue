<template>
    <el-dialog :model-value="dialogVisible" title="编辑图库" width="500" :before-close="handleClose">
        ...
        <el-form ref="ruleFormRef" style="max-width: 600px" :model="formData" :rules="rules" label-width="auto"
            ...
            <el-form-item label="壁纸类类型" prop="signName">
                <el-input v-model="formData.signName" />
            </el-form-item>
            <el-form-item label="壁纸分类名" prop="signName">
                <el-input v-model="formData.signName" />
            </el-form-item>
            <el-form-item label="壁纸类访问名" prop="signName">
                <el-input v-model="formData.signName" />
            </el-form-item>
            <el-form-item label="上传区域" prop="signName">
                <el-input v-model="formData.signName" />
            </el-form-item>
            ...
            <el-form-item label="国际化" prop="signName">
                <el-input v-model="formData.signName" />
            </el-form-item>
            <el-form-item label="是否运营类" prop="signName">
