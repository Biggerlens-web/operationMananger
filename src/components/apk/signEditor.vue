<template>
    <el-dialog :model-value="dialogVisible" title="编辑签名" width="500" :before-close="handleClose">
        ...
        <el-form ref="ruleFormRef" style="max-width: 600px" :model="formData" :rules="rules" label-width="auto"
            ...
            <el-form-item label="密钥库文件" prop="keyFile">
                <el-upload v-model:file-list="formData.keyFile" class="upload-demo" action="#" multiple>
                    <el-button type="primary">上传文件</el-button>

                </el-upload>
            </el-form-item>
            <el-form-item label="密钥库密码" prop="keypassword">
                <el-input v-model="formData.keypassword" />
            </el-form-item>
            <el-form-item label="别名" prop="otherName">
                <el-input v-model="formData.otherName" />
            </el-form-item>
            <el-form-item label="别名密码" prop="otherNamePassword">
                <el-input v-model="formData.otherNamePassword" />
            </el-form-item>
            <el-form-item label="包名" prop="packName">
                <el-input v-model="formData.packName" />
            </el-form-item>
        </el-form>
        <template #footer>
