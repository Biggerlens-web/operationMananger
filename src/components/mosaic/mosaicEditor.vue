                ...
                <el-form-item label="描边图" prop="big">
                    <div class="image-upload-container">
                        <el-upload class="image-uploader" v-model:file-list="formData.big" :show-file-list="false"
                            :limit="1" :on-change="handleBigChange" action="#" :auto-upload="false">
...
<script lang="ts" setup>
    ...
    const saveChange = async () => {
        ...
        try {
            ...
            const res = await service.post('/mosaic/save', form, {
                headers: {
    ...
    const batchSaveChange = async () => {
        ...
        try {
            ...
            const res = await service.post('/mosaic/saveBatch', form, {
                headers: {
                    'Content-Type': 'multipart/form-data'
                }
            })
