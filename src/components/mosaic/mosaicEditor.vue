<template>
    <el-dialog :model-value="dialogVisible" title="编辑马赛克" width="500" :before-close="handleClose">
        ...
        <el-form ref="ruleFormRef" style="max-width: 600px" :model="formData" :rules="rules" label-width="auto"
            ...
            <el-form-item label="是否会员" prop="packName">
                <el-switch v-model="formData.packName" />
            </el-form-item>
            <el-form-item label="缩略图" prop="keyFile">
                <el-upload v-model:file-list="formData.keyFile" class="upload-demo" action="#" multiple>
                    <el-button type="primary">上传文件</el-button>
                </el-upload>
            </el-form-item>
            <el-form-item label="马赛克图" prop="keyFile">
                <el-upload v-model:file-list="formData.keyFile" class="upload-demo" action="#" multiple>
                    <el-button type="primary">上传文件</el-button>
                </el-upload>
            </el-form-item>
