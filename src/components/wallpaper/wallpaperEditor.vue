<template>
    <el-dialog :model-value="dialogVisible" title="编辑壁纸" width="500" :before-close="handleClose">
        ...
        <el-form ref="ruleFormRef" style="max-width: 600px" :model="formData" :rules="rules" label-width="auto"
            ...
            <el-form-item label="图库分类名" prop="signName">
                <el-input v-model="formData.signName" />
            </el-form-item>
            <el-form-item label="图库类访问名" prop="signName">
                <el-input v-model="formData.signName" />
            </el-form-item>
