<template>
    <el-dialog :model-value="showEditor" title="编辑教程" width="500" :before-close="handleClose">
        <el-form ref="ruleFormRef" style="max-width: 600px" :model="formData" :rules="rules" label-width="auto"
            ...
            <el-form-item label="地区" prop="os">
                <el-select v-model="formData.os">
                    <el-option v-for="item in OSlist" :key="item" :label="item" :value="item" />
                </el-select>
            </el-form-item>
            <el-form-item label="教程类型" prop="os">
                <el-select v-model="formData.os">
                    <el-option v-for="item in OSlist" :key="item" :label="item" :value="item" />
                </el-select>
            </el-form-item>
            <el-form-item label="设备类型" prop="os">
                <el-select v-model="formData.os">
                    <el-option v-for="item in OSlist" :key="item" :label="item" :value="item" />
                </el-select>
            </el-form-item>
            <el-form-item label="分类类型" prop="os">
                <el-select v-model="formData.os">
                    <el-option v-for="item in OSlist" :key="item" :label="item" :value="item" />
                </el-select>
            </el-form-item>
            ...
            <el-form-item label="描述" prop="area">
                <el-input v-model="formData.area" />
            </el-form-item>
            <el-form-item label="封面图" prop="area">
                <el-upload v-model:file-list="formData.area" class="upload-demo" action="#">
                    <el-button type="primary">上传文件</el-button>
                </el-upload>
            </el-form-item>
            <el-form-item label="跳转标记类" prop="area">
                <el-input v-model="formData.area" />
            </el-form-item>
            <el-form-item label="跳转标记" prop="area">
                <el-input v-model="formData.area" />
            </el-form-item>
            <el-form-item label="视频" prop="area">
                <el-upload v-model:file-list="formData.area" class="upload-demo" action="#">
                    <el-button type="primary">上传文件</el-button>
                </el-upload>
            </el-form-item>
            <el-form-item label="教程等级" prop="os">
                <el-select v-model="formData.os">
                    <el-option v-for="item in OSlist" :key="item" :label="item" :value="item" />
                </el-select>
            </el-form-item>
            <el-form-item label="抖音视频链接" prop="area">
                <el-input v-model="formData.area" />
            </el-form-item>
            <el-form-item label="视频持续时间" prop="area">
                <el-input v-model="formData.area" />
            </el-form-item>
            <el-form-item label="是否为GIF" prop="area">
                <el-switch v-model="formData.area" />
            </el-form-item>
        </el-form>
