...
<script setup lang="ts">
    ...
    const searching = () => {
        ...
        console.log('backgroundFliterParams', backgroundFliterParams.value);
        getClothList();
    }
    ...
    onMounted(() => {
        ...
        if (Object.keys(backgroundFliterParams.value).length > 0) {
            searchParams.value = {
                ...backgroundFliterParams.value
            }
